...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-UMEHMRRX.js";
import {
  require_classnames,
  require_jsx_runtime,
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-JGZOMED7.js";
import {
  __commonJS,
  __toESM,
  require_react
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function useDropdownMenu(options = {}) {
  const context2 = (0, import_react4.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react4.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react5.default).createContext($704cf1d3b684cc5c$var$defaultContext);
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react5.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react6.useContext)(DropdownContext_default) || {};
...
function useDropdownItem({
  ...
  const onSelectCtx = (0, import_react7.useContext)(SelectableContext_default);
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react8.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react8.useRef)(null);
  const focusInDropdown = (0, import_react8.useRef)(false);
  const onSelectCtx = (0, import_react8.useContext)(SelectableContext_default);
  const toggle = (0, import_react8.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context2 = (0, import_react8.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react8.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react9.useCallback)((refValue) => {
...
var DropdownMenu2 = React9.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react10.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react10.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React11.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  const dropdownContext = (0, import_react11.useContext)(DropdownContext_default);
...
var Dropdown2 = React12.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
...
var NavDropdown = React13.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime13.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames6.default)(className, navItemPrefix),
